...
# print(launch_dict)
launch_dict_data = pd.DataFrame.from_dict(launch_dict)
print(launch_dict_data.head(100))


# Show the head of the dataframe
# launch_dict_data.isna()
launch_dict_data.head(100)
...
print(len(data_falcon9['LandingPad'].isnull()))
